			...
			.on(
					...
					function(event) {
						...
						if (record['数値_売上金額']['value'] !== ''
							...
							record['数値_現場利益']['value'] = Math.round(num1 / num2
									* 100);
						}
						...
						if (record['数値_B労務費']['value'] !== ''
							...
							record['数値_受注金額比較1']['value'] = Math.round((num1
									- num2 - num3)
									/ num1 * 100);
						}
						...
						if (record['数値_B直接経費']['value'] !== ''
							...
							record['数値_受注金額比較2']['value'] = Math
									.round((num1 - num2) / num1 * 100);
						}
						...
						if (record['数値_C労務費']['value'] !== ''
							...
							num2 = Number(record['数値_社員人件費']['value']);
							num3 = Number(record['数値_外注費']['value']);
							record['数値_売上金額比較1']['value'] = Math.round((num1
									- num2 - num3)
									/ num1 * 100);
						}
